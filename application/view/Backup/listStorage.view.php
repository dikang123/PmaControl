...
foreach ($data['storage'] as $storage) {
  ...
  <div class="progress-bar progress-bar-warning progress-bar-striped" style="width: '.$percent_backup.'%">
    ...
    echo '<td><a href="'.LINK.'backup/deleteStorageArea/'.$storage['id_backup_storage_area'].'" class="btn btn-danger delete-line"><span class="glyphicon glyphicon-trash" style="font-size:12px"></span> '.__("Delete").'</a></td>';
    echo '</tr>';
}
