...
class User extends Controller
{
    ...
    function index()
    {
        ...
        $sql = "SELECT a.id, a.firstname, a.name, b.id_country, a.email,b.libelle, COUNT( d.point ) AS points, e.name as rank, date_last_connected
			FROM user_main a
    ...
    function register()
    {
        ...
        if (!empty($_POST['user_main'])) {
            ...
            if (!$db->sql_save($data)) {
                ...
                mail("aurelien.lequoy@gmail.com", "New user on " . SITE_NAME, "Firstname : " . $data['user_main']['firstname'] . "\n"
...
GROUP BY d.id";
    ...
    function ldap()
    {
        ...
        if ($this->di['auth']->checkLdap("alequoy", "BXzmWRkj")) {
            echo "LOGGED";
        }
    }
