...
class Compare extends Controller
{
    ...
    public function getObjectDiff($param)
    {
        ...
        switch ($_GET['menu']) {
            case 'TABLE':
                $diff = $this->compareTable($_GET['compare_main']['database__original'], $_GET['compare_main']['database__compare'], $data['resultat'][$_GET['menu']]);

                $data['resultat'][$_GET['menu']] = $diff;
                break;

            default:
                $diff = $this->compareObject($_GET['compare_main']['database__original'], $_GET['compare_main']['database__compare'], $data['resultat'][$_GET['menu']]);
